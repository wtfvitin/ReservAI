...
// Verifica o parâmetro 'sucesso' na URL.
// =================================================================

// Verifica se a variável 'sucesso' existe e se é igual a '1'
...
<body>
    ...
    <div class="container">
        ...
        <?php else: ?>
            ...
            <p>Não foi possível confirmar sua reserva. Tente novamente ou entre em contato com o suporte.</p>
        <?php endif; ?>
